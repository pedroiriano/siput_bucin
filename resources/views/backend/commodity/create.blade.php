    ...
    <div class="row gx-4">
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body"><input class="form-control" id="commodity" name="commodity" type="text" placeholder="Masukkan Nama Komoditas (contoh: Daging Sapi Has Dalam)" /></div>
            </div>
            <div class="card mb-4">
