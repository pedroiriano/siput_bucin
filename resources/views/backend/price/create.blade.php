    ...
    <div class="row gx-4">
        <div class="col-lg-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="input-group input-group-joined">
                        ...
                        <input class="form-control ps-0 pointer" id="litepickerSingleDate" name="date" placeholder="Pilih Tanggal" />
                    </div>
                </div>
            </div>
            <div class="card mb-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <input class="form-control" id="price" name="price" type="number" placeholder="Masukkan Harga Komoditas (contoh: 155000)" />
                </div>
            </div>
        </div>
        <!-- Sticky Navigation-->
