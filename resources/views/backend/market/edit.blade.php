...
<!-- Main page content-->
<form action="{{ route('market-update', $mar->id) }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PUT')
<div class="container-fluid px-4">
    ...
    <div class="row gx-4">
        <div class="col-lg-8">
            <div class="card mb-4">
                ...
                <div class="card-body"><input class="form-control" id="market" name="market" type="text" placeholder="Masukkan Nama Pasar (contoh: Pasar Agung Depok)" value="{{ $mar->name }}" /></div>
            </div>
        </div>
        <!-- Sticky Navigation-->
        <div class="col-lg-4">
