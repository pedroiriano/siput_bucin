    ...
    <div class="row gx-4">
        <div class="col-lg-8">
            <div class="card mb-4">
                ...
                <div class="card-body"><input class="form-control" id="category" name="category" type="text" placeholder="Masukkan Nama Kategori (contoh: Daging Sapi)" /></div>
            </div>
            <div class="card mb-4">
                <div class="card-header">Unit</div>
                <div class="card-body"><input class="form-control" id="unit" name="unit" type="text" placeholder="Masukkan Satuan Unit (contoh: Kg, Lt, dan lainnya)" /></div>
            </div>
        </div>
        <!-- Sticky Navigation-->
        <div class="col-lg-4">
