            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                    <h1 class="page-header-title">
                        ...
                        Analisis Perbandingan Komoditas Pasar
                    </h1>
                    <div class="page-header-subtitle">Analisis Data Perbandingan Komoditas Pasar</div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    @if ($pill == 1)
                        <div class="tab-content" id="dashboardNavContent">
                            <div class="tab-pane fade show active" id="weekly" role="tabpanel" aria-labelledby="weekly-pill">
                                @include('inc.chart.weekly-comparison')
                                <div class="chart-area mb-4 mb-lg-0" style="height: 20rem">
                                    <canvas id="weeklyAreaChart" width="100%" height="30"></canvas>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="monthly" role="tabpanel" aria-labelledby="monthly-pill">
                                @include('inc.chart.monthly-comparison')
                                <div class="chart-area mb-4 mb-lg-0" style="height: 20rem">
                                    <canvas id="monthlyAreaChart" width="100%" height="30"></canvas>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="yearly" role="tabpanel" aria-labelledby="yearly-pill">
                                @include('inc.chart.yearly-comparison')
                                <div class="chart-area mb-4 mb-lg-0" style="height: 20rem">
                                    <canvas id="yearlyAreaChart" width="100%" height="30"></canvas>
                                </div>
                            </div>
                        </div>
                    @elseif ($pill == 2)
...
@section('js')
@if ($pill == 1)
    @include('inc.chart.weekly-comparison-js')
@elseif ($pill == 2)
    @include('inc.chart.monthly-comparison-js')
@elseif ($pill == 3)
    @include('inc.chart.yearly-comparison-js')
@else
    @include('inc.chart.weekly-comparison-js')
@endif
@endsection
