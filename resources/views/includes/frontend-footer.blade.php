<div id="layoutDefault_footer">
    <footer class="footer pt-10 pb-5 mt-auto bg-dark footer-dark">
        <div class="container px-5">
            <div class="row gx-5">
                <div class="col-lg-3">
                    <div class="footer-brand">Siput Bucin</div>
                    <div class="mb-3">Belanja & Bisnis semakin mudah</div>
                ...
                <div class="col-lg-9">
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-6 mb-5 mb-md-0">
                            <div class="text-uppercase-expanded text-xs mb-4">Dukungan</div>
                            <ul class="list-unstyled mb-0">
                                <li class="mb-2"><a href="#!">Cara Bergabung</a></li>
